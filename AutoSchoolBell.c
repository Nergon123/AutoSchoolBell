...
unsigned char hour, min, sec, week_day, day, month, year, oldmin; // oldmin - ������ ������
unsigned char menu1;
    ...
    do
    {
        ...
        case 0b11111101:
            ...
            if (pos == 1)
                te_print(pos, st.hour[tob]);
            if (pos == 2)
                te_print(pos, st.min[tob]);
            if (pos == 3)
                te_print(pos, st.TimeBell[tob]);
            if (pos == 4)
                te_print(pos, st.BellMode[tob]);
            break;
        case 0b11111011:
            if (pos == 1)
                if (st.hour[tob] < 23)
            ...
            if (pos == 2)
                if (st.min[tob] < 59)
                    st.min[tob]++;
            if (pos == 3)
                if (st.TimeBell[tob] < 99)
                    st.TimeBell[tob]++;
            if (pos == 4)
                if (st.BellMode[tob] < 99)
                    st.BellMode[tob]++;
            if (pos == 1)
                te_print(pos, st.hour[tob]);
            if (pos == 2)
        ...
        case 0b11101111:
            ...
            if (pos == 2)
                if (st.min[tob] > 0)
                    st.min[tob]--;
            if (pos == 3)
                if (st.TimeBell[tob] > 0)
                    st.TimeBell[tob]--;
            if (pos == 4)
                if (st.BellMode[tob] > 0)
                    st.BellMode[tob]--;
            if (pos == 1)
                te_print(pos, st.hour[tob]);
            if (pos == 2)
